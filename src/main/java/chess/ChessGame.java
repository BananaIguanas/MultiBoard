...
public class ChessGame {
	...
	private static ArrayDeque<ChessMove> moveHistory = new ArrayDeque<>();
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			processUserInput(input.nextLine());
		}
	}
	...
	private static int[] processChessLocation(String input) {
		if (input.length() == 2) {
